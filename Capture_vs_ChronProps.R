...
plotDat$Prop1 <- factor(plotDat$Property, levels = c("AR1Dat", "corDat", "rbarDat", "sdDat"),
                        labels = c("AR1", "Corr_Targ", "rbar", "SampDepth"))
...
ggplot(data=plotDat, mapping=aes(x=Prop1, y=value, color=Site1, shape=Reconstruction_Error)) +
  ...
  facet_grid(Boot~Prop1, scales = "free_x")+
...
ggsave(filename = "C:/Users/dce72/Documents/GradSchool/Uncertainty/Fig5.png", width = 7, height = 3.5)
